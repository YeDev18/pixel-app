...
function CibleCard({ id }) {
  ...
  return (
    <div className="w-[250px] sm:w-[300px] md:w-[350px] lg:w-[400px] h-[150px] sm:h-[200px] bg-[#0a2b38] flex flex-col justify-center p-4 sm:p-6 rounded-[30px] sm:rounded-[50px] shadow-md hover:shadow-lg transition-transform duration-300 transform hover:scale-105">
